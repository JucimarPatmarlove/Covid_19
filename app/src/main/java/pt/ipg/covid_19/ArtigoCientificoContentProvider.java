...
public class ArtigoCientificoContentProvider extends ContentProvider {
    private static final String AUTHORITY = "pt.ipg.covid_19";
    private static final String CATEGORIAS = "categorias";
    private static final String ArtigoCientifico = "artigocientifico";
    ...
    public static final Uri ENDERECO_ArtigoCientifico = Uri.withAppendedPath(ENDERECO_BASE, ArtigoCientifico);

    private static final int URI_CATEGORIAS = 100;
    private static final int URI_ID_CATEGORIA = 101;
    private static final int URI_ArtigoCientifico = 200;
    private static final int URI_ID_ArtigoCientifico = 201;
    ...
    private BdArtigoCientificoOpenHelper openHelper;
    ...
    private UriMatcher getUriMatcher(){
        ...
        uriMatcher.addURI(AUTHORITY, ArtigoCientifico, URI_ArtigoCientifico);
        uriMatcher.addURI(AUTHORITY, ArtigoCientifico + "/#", URI_ID_ArtigoCientifico);
    ...
    public boolean onCreate() {
        openHelper = new BdArtigoCientificoOpenHelper(getContext());
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        switch (getUriMatcher().match(uri)) {
            ...
            case URI_ArtigoCientifico:
                return new BdTableArtigoCientifico(bd).query(projection, selection, selectionArgs, null, null, sortOrder);

            case URI_ID_ArtigoCientifico:
                return new BdTableArtigoCientifico(bd).query(projection, BdTableArtigoCientifico._ID + "=?", new String[] { id }, null, null, sortOrder);
    ...
    public String getType(@NonNull Uri uri) {
        ...
        switch (codigoUri) {
            ...
            case URI_ArtigoCientifico:
                return CURSOR_DIR + ArtigoCientifico;
            case URI_ID_ArtigoCientifico:
                return CURSOR_ITEM + ArtigoCientifico;
            default:
                return null;
        }
    }
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        ...
        switch (getUriMatcher().match(uri)) {
            ...
            case URI_ArtigoCientifico:
                id = (new BdTableArtigoCientifico(bd).insert(values));
                break;
    ...
    public int delete(@NonNull Uri uri, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        switch (getUriMatcher().match(uri)) {
            ...
            case URI_ID_ArtigoCientifico:
                return new BdTableArtigoCientifico(bd).delete(BdTableArtigoCientifico._ID + "=?", new String[] { id });
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues values, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        switch (getUriMatcher().match(uri)) {
            ...
            case URI_ID_ArtigoCientifico:
                return new BdTableArtigoCientifico(bd).update(values,BdTableArtigoCientifico._ID + "=?", new String[] { id });
